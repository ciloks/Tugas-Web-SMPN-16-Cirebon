      ...
      <br>
        <span>Masukkan Nama :&nbsp&nbsp</span> <input type="text" name="cari">
          <span>Berdasarkan : &nbsp</span>
            ...
            <a class="a" href="tampil_guru.php">Kembali</a>
    </div><br>
  </form>
  </div>
...
<?php
        ...
        while($d = mysqli_fetch_array($query)){
          ...
          <tr>
            ...
            <td><img src="../fotoguru/<?php echo $d['Foto'] ?>" width="45px" height="50px"></td>
            <td><a  class="a" href="edit_guru.php?id_guru=<?php echo $d['id_guru']; ?>"> Edit </a> ||
            <a  class="a" href="hapus_guru.php?id_guru=<?php echo $d['id_guru']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data ini?')"> Hapus </a></td>
          </tr>
          <?php
        }
