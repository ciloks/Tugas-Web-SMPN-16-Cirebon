...
<div align="center">
  <a href="login_admin_guru.php" class="tombol"><img src="user.png" alt="login" width="30"></a>
</div>
   ...
   <table class="content-table" width="80%">
        ...
        while($d = mysqli_fetch_array($data)){
          ...
          <tr>
            ...
            <td><a  class="a" href="edit_guru.php?id_guru=<?php echo $d['id_guru']; ?>"> Edit </a>&nbsp
            <a  class="a" href="hapus_guru.php?id_guru=<?php echo $d['id_guru']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data ini?')"> Hapus </a>&nbsp <a  class="a" href="detail_guru.php?id_guru=<?php echo $d['id_guru']; ?>"> Detail </a></td>
          </tr>
          <?php
        }
        ?>
